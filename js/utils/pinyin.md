 ...
 * @namespace Browser
 * 
 * @param {String} _key 拼音
 * @param {ASCII code} _value ascii码
 * @example alert(convertToPinyinLower("你好啊"));
 * 
 */
 ...
 * 
 * @param {Number} code  ascii 码
 * @returns {String} key 字符
 */
function getKey (code) {
    if ((code > 0) && (code < 160))
        // String.fromCharCode 是把 ascii 码转成字符
 ...
 * 判断中英文
 * 
 * @param {String} str 中英文
 * @returns {Boolean} 是否是中文
 */
function isChinese (str) {
    let entryVal = str;
    let cnChar = entryVal.match(/[^\x00-\x80]/g);
